...
},{}],"img/backblaze-logo.jpg":[function(require,module,exports) {
module.exports = "/backblaze-logo.f8031ae0.jpg";
},{}],"img/cloudflare-logo.jpg":[function(require,module,exports) {
module.exports = "/cloudflare-logo.98c4ec60.jpg";
},{}],"img/aws-logo.png":[function(require,module,exports) {
module.exports = "/aws-logo.caeabdc7.png";
...
var _backblazeLogo = _interopRequireDefault(require("./../../img/backblaze-logo.jpg"));

var _cloudflareLogo = _interopRequireDefault(require("./../../img/cloudflare-logo.jpg"));

var _awsLogo = _interopRequireDefault(require("./../../img/aws-logo.png"));
...
function Home() {
  ...
  return (0, _preact.h)("div", {
    ...
    src: _apps.default,
    alt: "applications"
  }), (0, _preact.h)("p", null, (0, _preact.h)("strong", null, "Solution")), (0, _preact.h)("p", null, "Use Hashcache to secure ", (0, _preact.h)("em", null, "only"), " the cells of spreadsheets containing sensitive raw data before uploading to the cloud."), (0, _preact.h)("p", null, "Your app can still leverage metadata such as: rows, columns and filenames to provide analytics and support."), (0, _preact.h)("p", null, (0, _preact.h)("strong", null, "Key Points")), (0, _preact.h)("ul", null, (0, _preact.h)("li", null, "The customer is now in control of securing their sensitive data"), (0, _preact.h)("li", null, "You retain quality app usage metrics and Analytics"), (0, _preact.h)("li", null, "With ", (0, _preact.h)("em", null, "less"), " sensitive data stored in your database, you can save on security and compliance costs")), (0, _preact.h)("p", null, (0, _preact.h)("strong", null, "A win win for you and your customers"))), (0, _preact.h)("section", null, (0, _preact.h)("h1", null, "What is Hashcache?"), (0, _preact.h)("p", null, "Hashcache is a data API for businesses that removes security and compliance risk and makes privacy a competitive advantage."), (0, _preact.h)("p", null, "Developers obtain an API key and install a small JavaScript library. That's it!"), (0, _preact.h)("p", null, "See the code sample above for how easy it is to work with Hashcache."), (0, _preact.h)("p", null, "Currently an invite only beta. ", (0, _preact.h)("a", {
    href: "mailto:hashcache@protonmail.com"
  }, " Contact"), " if you are interested.")), (0, _preact.h)("section", null, (0, _preact.h)("h1", null, "Customer Experience"), (0, _preact.h)("p", null, "Hashcache was designed with developers in mind, but also their customers."), (0, _preact.h)("p", null, "As a developer you can create unique accounts for your customers, without revealing any personal information to Hashcache."), (0, _preact.h)("p", null, "Customers only have to set a \"Data 2 Factor\" (D2F) password that protects their data from anyone they do not share it with.")), (0, _preact.h)("section", {
    className: [_HomeModule.fullWidth, _HomeModule.logo].join(' ')
  }, (0, _preact.h)("section", {
    className: _HomeModule.fullWidth
  }, (0, _preact.h)("h1", null, "Technology")), (0, _preact.h)("div", null, (0, _preact.h)("img", {
    src: _cloudflareLogo.default,
    alt: "cloudflare"
  })), (0, _preact.h)("div", null, (0, _preact.h)("img", {
    src: _backblazeLogo.default,
    alt: "backblaze"
  })), (0, _preact.h)("div", null, (0, _preact.h)("img", {
    src: _awsLogo.default,
    alt: "amazon web services"
  }))), (0, _preact.h)("section", null, (0, _preact.h)("a", {
    name: "about"
...
},{"preact":"../node_modules/preact/dist/preact.module.js","preact/hooks":"../node_modules/preact/hooks/dist/hooks.module.js","./../../components/Hero/Hero":"components/Hero/Hero.js","./../../img/how.png":"img/how.png","./../../img/apps.png":"img/apps.png","./../../img/backblaze-logo.jpg":"img/backblaze-logo.jpg","./../../img/cloudflare-logo.jpg":"img/cloudflare-logo.jpg","./../../img/aws-logo.png":"img/aws-logo.png","./Home.module.scss":"routes/Home/Home.module.scss"}],"App.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33295" + '/');
